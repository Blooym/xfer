...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ |
| `xfer.blooym.dev` | Very limited max upload size, low transfer retention time and ratelimits on how many transfers can be made in a time period. | [@Blooym](https://github.com/Blooym) |
